...
const FOOTER_TEXT =
	...
	`<span class="ot-hc-links"><a href="https://github.com/akoenig">${GITHUB_ICON}akoenig</a><a href="https://x.com/ItsAndreKoenig">${X_ICON}ItsAndreKoenig</a></span>` +
	`</span></span>. Source on [GitHub](https://github.com/akoenig/opentunnel).`;
